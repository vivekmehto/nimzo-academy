      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16 animate-fade-up">
          ...
          <p className="text-lg text-[var(--color-body-700)]">
            Parents refer Nimzo Academy when they believe in the discipline,
            structure, and care behind the coaching. This program helps you bring
            more serious learners into that environment.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-[var(--radius-lg)]
            ...
            bg-[var(--color-white-100)] animate-fade-up">
            <h3 className="text-xl font-semibold mb-4 text-[var(--color-heading-900)]">
              Coaching Fee Credits
            </h3>

            <p className="text-[var(--color-body-700)]">
              Families who help expand the academy through genuine referrals
              receive coaching fee credits as a practical thank you.
            </p>
          </div>
        </div>
      </div>
