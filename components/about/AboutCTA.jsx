  ...
  return (
    <section className="bg-back-500 py-28 md:py-36">
      <div className="mx-auto max-w-3xl px-6 text-center animate-fade-up">
        ...
        {/* Soft kicker */}
        <p className="text-sm font-medium text-muted-500 mb-3">
          A thoughtful beginning matters
        </p>

        {/* Headline */}
        <h2 className="text-3xl md:text-4xl font-semibold text-(--color-heading-900) leading-tight">
          Let’s Find the Right Starting Point for Your Child
        </h2>

        {/* Main copy */}
        <p className="mt-6 text-base md:text-lg leading-relaxed text-body-700">
