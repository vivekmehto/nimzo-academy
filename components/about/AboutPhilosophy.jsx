...
export default function AboutPhilosophy() {
  return (
    <section className="bg-light-100 py-20 md:py-24">
      <div className="mx-auto max-w-6xl px-6">

        {/* Header */}
        <div className="max-w-3xl mb-10 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold text-(--color-heading-900)">
            Our Teaching Philosophy
          </h2>

          <p className="mt-4 text-base md:text-lg leading-relaxed text-body-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
          ...
          <div className="md:col-span-3 space-y-10 md:space-y-8 order-1">
            <div>
              <h3 className="font-semibold text-(--color-heading-900)">
                We don’t rush beginners
              </h3>
              <p className="mt-2 text-body-700 leading-relaxed">
          ...
          <div className="md:col-span-2 order-2 md:pt-2">
            <div className="overflow-hidden rounded-(--radius-lg) bg-white-100">
              <Image
